import 'package:delivery/src/controllers/clientControllers/client_orders_map_controller.dart';
...
class _cardOrderInfo extends StatelessWidget {
  const _cardOrderInfo({
    required ClientOrdersMapcontroller con,
  }) : _con = con;

  final ClientOrdersMapcontroller _con;
              ...
              InkWell(
                    child: CircleAvatar(
                      ...
                      backgroundImage: Image.network(
                        _con.order?.delivery?.image ?? 'assets/images/user.png',
                  ...
                  Container(
                    ...
                    child: headerText(text: '${_con.order?.delivery?.name! ?? ''} ${_con.order?.delivery?.lastname! ?? ''}', maxLines: 1),
                  ),
                  const Spacer(),
                  Container(
                    decoration: BoxDecoration(
