...
class DeliveryOrdersDetailPage extends StatefulWidget {
  Order order;
  DeliveryOrdersDetailPage({super.key, required this.order});
...
class _DeliveryOrdersDetailPageState
    extends State<DeliveryOrdersDetailPage> {
  final DeliveryOrderDetailController _con =
...
class WidgetProductList extends StatelessWidget {
  const WidgetProductList({
    super.key,
    required DeliveryOrderDetailController con,
