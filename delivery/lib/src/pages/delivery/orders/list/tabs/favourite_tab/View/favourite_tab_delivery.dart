...
class FavouriteTabDelivery extends StatefulWidget {
  const FavouriteTabDelivery({super.key});

  @override
  State<FavouriteTabDelivery> createState() => _FavouriteTabDeliveryState();
}

class _FavouriteTabDeliveryState extends State<FavouriteTabDelivery> {
  @override
  Widget build(BuildContext context) {
  return
    const Center(
      child: Text('favourite delivery'),
    );
  //   return Scaffold(
