...
class FMyOrderTabRestaurant extends StatefulWidget {
  const FMyOrderTabRestaurant({super.key});

  @override
  State<FMyOrderTabRestaurant> createState() => _FMyOrderTabRestaurantState();
}

class _FMyOrderTabRestaurantState extends State<FMyOrderTabRestaurant> {
  final emptyOrderState = false;
  @override
  Widget build(BuildContext context) {
     return const Center(child: Text('order  Restaurant'),);
    // return Scaffold(
