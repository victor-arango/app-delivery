...
class RestaurantOrdersDetailPage extends StatefulWidget {
  Order order;
  RestaurantOrdersDetailPage({super.key, required this.order});
                    ...
                    children: [
                      SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                               _con.order!.status == 'PAGADO' ?  headerText(text: 'Asignar repartidor', color: MyColors.primaryColor) : headerText(text: 'Repartidor asiganado', color: MyColors.primaryColor),
                                     _con.order!.status != 'PAGADO' ?  Row(
            children: [
              Container(
              ...
              Text('${_con.order?.delivery?.name} ${_con.order?.delivery?.lastname} '),
                             ...
                             _con.order!.status == 'PAGADO' ? _DropDown(
                          con: _con,
                          users:_con.users,
...
class WidgetProductList extends StatelessWidget {
  const WidgetProductList({
    super.key,
    required RestaurantOrderDetailController con,
...
class _DropDown extends StatelessWidget {
  ...
  final RestaurantOrderDetailController con;
          ...
          children: [
            Container(
              ...
              child: DropdownButton(
                ...
                hint: headerText(text: 'Selecciona el repartidor'),
                elevation: 3,
                isExpanded: true,
